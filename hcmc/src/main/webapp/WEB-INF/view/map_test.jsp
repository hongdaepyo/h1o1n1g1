...
#menu_wrap {position:absolute;top:8vh;left:-22vw;bottom:0;width:250px;margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(0, 0, 0, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
