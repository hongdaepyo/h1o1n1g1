	...
	<div class="festival_manage">
		<c:forEach items="${list}" var="a">
			<form action="/adminFestivalUpdate.do">
				<input type="text" name="festival_num" value="${a.festival_num}">
				<input type="text" name="festival_name" value="${a.festival_name}">
				<input type="text" name="festival_start" value="${a.festival_start}">
				<input type="text" name="festival_end" value="${a.festival_end}">
				...
				<input type="text" name="festival_count" value="${a.festival_count}">
				<input type="text" name="festival_content" value="${a.festival_content}">
				<input type="text" name="star" readonly="readonly" value="${a.star}">
