...
INSERT INTO f_member
		VALUES(SEQ_f_member_mem_num.nextval,'jun1@admin.com','a1234','aa','0');
INSERT INTO f_member
...
insert into f_favor values(3,36,8);

delete from f_favor where f_favor_num=8
