...
insert into board(num,reg_date,writer,email,subject,content,upload,ref,re_step,re_level) values(board_seq.nextval, sysdate, 'sdf', 'sd', 'sdf', 'sdf', 'sdf', board_seq.nextval,0,0);
