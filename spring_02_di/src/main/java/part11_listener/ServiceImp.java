...
/*
 * 1)BeanNameAware은 빈객체가 자신의 이름을 알아야 할 때 사용된다.
 * 2)BeanFactoryAware은 빈에 대한 정보를 알려준다.
 * 3)ApplictaionContextAware은 ApplicationContext를 빈에 전달할때 사용된다.
 * 4)InitializingBean은 객체를 생성하고 프로퍼티를 초기화하고, 
 *   컨테이너에 관한 설정을 완료한 뒤에 호출되는 매서드를 정의하고 있다.
...
public class ServiceImp implements Service, BeanNameAware, BeanFactoryAware, ApplicationContextAware,
