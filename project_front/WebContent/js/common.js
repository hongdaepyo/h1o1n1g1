$(function(){
  ...
  $("#user_id, #user_pw").on("focus",function(){
	  ...
	  $("#total_close a").on("click",function(){
		  alert($(this).parents('p').prev().html());
		   $("#total_menu").slideUp("normal");
		   $("img",$(this).parent().parent().prev()).attr("src",$("img",$(this).parents(2).prev()).attr("src").replace("over.gif","out.gif"));
		   //$("#total_btn img").attr("src",$("#total_btn img").attr("src").replace("over.gif","out.gif"));
		   return false;
	  });
